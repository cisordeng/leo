...
func TestMail(t *testing.T) {
	config := `{"username":"cisordeng@gmail.com","password":"cisordeng","host":"smtp.gmail.com","port":587}`
	mail := NewEMail(config)
	if mail.Username != "cisordeng@gmail.com" {
		t.Fatal("email parse get username error")
	}
	if mail.Password != "cisordeng" {
